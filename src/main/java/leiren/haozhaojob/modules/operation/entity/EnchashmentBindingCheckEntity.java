 ...
 */
@TableName("t_enchashment_binding_check")
public class EnchashmentBindingCheckEntity implements Serializable {
	...
	public void setEnchashmentId(Integer enchashmentId) {
