 ...
 */
@TableName("t_wb_card")
public class WbCardEntity implements Serializable {
	 ...
	 * 发行方类型 1:平台 2:商户
	 */
	@NotNull(message="发行方类型不能为空", groups = {AddGroup.class, UpdateGroup.class})
	 ...
	 * 用户最多持有张数
	 */
	@NotNull(message = "用户最多持有张数",groups = {AddGroup.class,UpdateGroup.class})
	private Integer limitNum;
	/**
	 * 卡券logo
	 */
	@NotNull(message = "卡券logo不能为空",groups = {AddGroup.class,UpdateGroup.class})
	@NotBlank(message="卡券logo不能为空", groups = {AddGroup.class, UpdateGroup.class})
	private String logo;
	/**
