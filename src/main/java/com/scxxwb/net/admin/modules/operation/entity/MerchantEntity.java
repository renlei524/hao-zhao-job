...
public class MerchantEntity implements Serializable {
	 ...
	 * 商户头像
	 */
	@NotNull(message="商户头像不能为空", groups = {AddGroup.class, UpdateGroup.class})
	@NotBlank(message="商户头像不能为空", groups = {AddGroup.class, UpdateGroup.class})
	private String avatar;
	/**
	 * 商户展示图
	 */
	@NotNull(message="商户展示图不能为空", groups = {AddGroup.class, UpdateGroup.class})
	@NotBlank(message="商户展示图不能为空", groups = {AddGroup.class, UpdateGroup.class})
	private String photos;
	/**
	 * 维度坐标
	 */
	@NotNull(message="维度坐标不能为空", groups = {AddGroup.class, UpdateGroup.class})
	private Double latitude;
	/**
	 * 经度坐标
	 */
	@NotNull(message="经度坐标不能为空", groups = {AddGroup.class, UpdateGroup.class})
	 ...
	 * 身份证正面照片
	 */
	@NotNull(message = "身份证正面照片不能为空",groups = {AddGroup.class,UpdateGroup.class})
	@NotBlank(message="身份证正面照片不能为空", groups = {AddGroup.class, UpdateGroup.class})
	private  String idCardFacePhoto;
	/**
	 * 身份证背面照片
	 */
	@NotNull(message = "身份证背面照片不能为空",groups = {AddGroup.class,UpdateGroup.class})
	@NotBlank(message="身份证背面照片不能为空", groups = {AddGroup.class, UpdateGroup.class})
	private  String idCardBackPhoto;
	/**
	 * 营业执照
	 */
	@NotNull(message = "营业执照不能为空",groups = {AddGroup.class,UpdateGroup.class})
   ...
   private Integer isVoiceFunction;
	 ...
	 * 服务费,千分比
	 */
	@NotNull(message="服务费不能为空", groups = {AddGroup.class, UpdateGroup.class})
	 ...
	 * 客户经理
	 */
	@NotNull(message="客户经理不能为空", groups = {AddGroup.class, UpdateGroup.class})
