...
var clickEventListener = AMap.event.addListener(mapObj, 'click', function(e) {
    vm.merchant.latitude = e.lnglat.getLng();
    vm.merchant.longitude = e.lnglat.getLat();
    document.getElementById("lngX").value = vm.merchant.latitude;
    document.getElementById("latY").value = vm.merchant.longitude;
});
