...
var vm = new Vue({
    ...
    methods: {
        getMenu: function(menuId){
            //加载菜单树
            $.get(baseURL + "community/menu/select", function(r){
        ...
        update: function () {
            ...
            $.get(baseURL + "community/menu/info/"+menuId, function(r){
                vm.showList = false;
                vm.title = "修改";
                vm.menu = r.menu;
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseURL + "community/menu/delete",
                    data: "menuId=" + menuId,
                    success: function(r){
                        if(r.code === 0){
                            alert('操作成功', function(){
        ...
        saveOrUpdate: function () {
        	...
        	$("#text1").attr("status", "N");
            if(vm.menu.type === "0" || vm.menu.type == 0){
            	vm.menu.url = "";
            	vm.menu.perms = "";
            }else if(vm.menu.type === 2 || vm.menu.type == 2){
            	vm.menu.url = "";
            	vm.menu.icon = "";
            }
            var url = vm.menu.menuId == null ? "community/menu/save" : "community/menu/update";
            $.ajax({
                type: "POST",
                url:  baseURL + url,
...
$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL + "community/menu/list", colunms);
