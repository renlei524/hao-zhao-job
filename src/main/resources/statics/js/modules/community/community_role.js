$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'community/role/list',
        datatype: "json",
        colModel: [
    ...
    methods: {
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseURL + "community/role/delete",
        ...
        getRole: function(roleId){
            $.get(baseURL + "community/role/info/"+roleId, function(r){
                vm.role = r.role;
        ...
        saveOrUpdate: function () {
            ...
            var url = vm.role.roleId == null ? "community/role/save" : "community/role/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
                contentType: "application/json",
